...
const LeadsData: React.FC<LeadsDataProps> = ({
  lead,
  handleEdit,
  tagsCategories,
  statuses,
      ...
      <td className={` relative p-3`}>
        <div className="flex text-base items-center">
          {/* <div>
            <div className="dropdown">
              <div
                ...
                id="dropdown-toggle-157-JzjOVIXHuE"
              >
          ...
          <button
            ...
            className="cursor-pointer circle items-center cursor-pointer hover:text-indigo-500"
          >
            <svg
              stroke="currentColor"
              fill="none"
