...
const TasksHeader: React.FC<TasksHeaderProps> = () => {
    const { data: tasks, status, error } = useSelector((state: { tasks: any}) => state.tasks);
                            ...
                            <div className="bg-white rounded-md border">
                                <div className="flex p-5 justify-between items-center">
                                    <div className="flex items-center gap-4 ">
                                        <span className=" !bg-indigo-600 flex justify-center items-center rounded-md  w-[55px] h-[55px]" >
                            ...
                            <div className="bg-white rounded-md border">
                                <div className="flex p-5 justify-between items-center">
                                    <div className="flex items-center gap-4 ">
                                        ...
                                        <div className='text-sm '>
                                            <span className='text-[#6B7280] text-base'> Completed Tasks</span>
                                            {/* Replace the hardcoded value with your actual completed tasks count */}
                                            <h3><span>10</span></h3>
                                        </div>
                                    </div>
                                </div>
